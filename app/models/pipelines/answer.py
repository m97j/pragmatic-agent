# app/models/pipelines/answer.py
...
class AnswerPipeline(BasePipeline):
    """
    User-facing text generation pipeline.

    Characteristics:
    - prompt engineering only (no reasoning/controller)
    - sampling-based decoding
    - supports streaming
    - return markdown formatted answers
    """
    ...
    def __init__(self, runtime: LLMRuntime):
        ...
        output_transform = MarkdownOutput(runtime=runtime)
